...
QUERIES_SELECT = {
    "Список всех лайков пользователя": {
        "Mongo": time_get_likes_user,
        "Postgres": time_get_likes_user_pg,
    },
    "Количество лайков фильма": {
        "Mongo": time_count_likes_movie,
        "Postgres": time_count_likes_movie_pg,
    },
    "Список закладок пользователя": {
        "Mongo": time_get_bookmarks_user,
        "Postgres": time_get_bookmarks_user_pg,
    },
    "Средняя оценка фильма": {"Mongo": time_avg_score, "Postgres": time_avg_score_pg},
}
